...
2. Start the workspace: [![Contribute](factory-contribute.svg)](https://router64dmwsb-user1-che.apps.cluster-xpxnp.xpxnp.sandbox80.opentlc.com/factory?url=https://github.com/redhat-developer-demos/quarkus-reactjs-postit-app)

The URL should use your instance of Che/CodeReady Workspaces:

```
https://router64dmwsb-user1-che.apps.cluster-xpxnp.xpxnp.sandbox80.opentlc.com/factory?url=https://github.com/redhat-developer-demos/quarkus-reactjs-postit-app
```
